            ...
            <form method="POST" enctype="multipart/form-data" action="{{url('/admin/apps')}}">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="@lang('admin.app_title')" />
                    </div>

                    <div class="form-group">
                        <img src="{{ asset('images/no_image.png') }}" class="app-image">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description" class="form-control" placeholder="@lang('admin.app_description')" />
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select title="@lang('admin.select_platform')" name="platform" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-icon="{{ $platform->fa_icon }}" value="{{ $platform->id }}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select title="@lang('admin.select_button')" name="type" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-icon="fas fa-external-link-alt" value="2">@lang('admin.visit_page')
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="developer" class="form-control" placeholder="@lang('admin.app_developer')" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="license" class="form-control" placeholder="@lang('admin.app_license')" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="file_size" class="form-control" placeholder="@lang('admin.app_file_size')" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="url" class="form-control" placeholder="@lang('admin.app_download_page_url')" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="textarea textarea-style" name="details" placeholder="@lang('admin.app_detailed_description')"></textarea>
                    </div>
