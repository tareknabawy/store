                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" rows="3"
                            placeholder="@lang('admin.custom_meta_description')"></textarea>
                    </div>

                    <div class="form-group">
                        <label>@lang('admin.category_icon')</label>
                        <select title="@lang('admin.select_icon')" name="fa_icon" class="form-control selectpicker" data-live-search="true">
