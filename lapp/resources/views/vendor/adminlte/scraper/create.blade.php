...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box">
            ...
            <!-- form -->
            <form method="POST" enctype="multipart/form-data" action="{{url('/admin/scraper')}}">
                @csrf @method('POST')

                <input type="hidden" name="image" value="{{$app['image']}}" />
                <input type="hidden" name="screenshots" value="{{implode(',', $app['screenshots'])}}" />
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="description" class="form-control" value="{{$description}}" placeholder="@lang('admin.app_description')" />
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select title="@lang('admin.select_category')" name="category" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-icon="{{ $category->fa_icon }}" value="{{ $category->id }}" {{ $category->id == $item_category ? ' selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select title="@lang('admin.select_platform')" name="platform" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-icon="{{ $platform->fa_icon }}" value="{{ $platform->id }}" {{ $platform->title == 'Android' ? ' selected' : '' }}>{{ $platform->title }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select title="@lang('admin.select_button')" name="type" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-icon="fas fa-external-link-alt" value="2" selected>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="slug" class="form-control" value="" placeholder="@lang('admin.slug')" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="developer" class="form-control" value="{{$app['author']}}" placeholder="@lang('admin.app_developer')" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @php if (is_null($app['price'])) { $app_price = __('admin.free'); } else { $app_price =
                            $app['price']; } @endphp
                            <div class="form-group">
                                <label>@lang('admin.app_license')</label>
                                <input type="text" name="license" class="form-control" value="{{$app_price}}" placeholder="@lang('admin.app_license')" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="file_size" class="form-control" value="{{$app['size']}}" placeholder="@lang('admin.app_file_size')" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="url" class="form-control" value="{{$app['url']}}" placeholder="@lang('admin.app_download_page_url')" />
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="textarea textarea-style" name="details" placeholder="@lang('admin.app_detailed_description')">{{$detailed_description}}</textarea>
                    </div>
