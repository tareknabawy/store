...
@elseif($key === 'twitter_site')
    <meta name="twitter:site" content="{{ '@'.$tags[$key] }}"/>
@elseif($key === 'twitter_card')
    <meta name="twitter:card" content="{{ $tags[$key] }}"/>
@elseif($key === 'twitter_title')
    <meta name="twitter:title" content="{{ $tags[$key] }}"/>
@elseif($key === 'twitter_url')
    <meta name="twitter:url" content="{{ $tags[$key] }}"/>
@elseif($key === 'twitter_description')
    <meta name="twitter:description" content="{{ $tags[$key] }}"/>
@elseif($key === 'twitter_image')
    <meta name="twitter:image" content="{{ $tags[$key] }}"/>
